...
export default function Layout() {
  ...
  const loadingUi = (
    <div className="loading fixed inset-0 flex flex-col justify-center items-center z-10 bg-zinc-900 overflow-x-hidden">
      <div className="absolute animate-pulse rounded-full left-1/2 -translate-x-1/2 blur-3xl -top-150 size-200 bg-radial to-zinc-950 via-blue-500 via-40% from-blue-300"></div>
